  ...
  >
    <div class="el-progress-bar" v-if="type === 'line'">
      <div class="el-progress-bar__outer" :style="{height:strokeWidth + 'px'}">
        <div class="el-progress-bar__iner" :style="barStyle">
    ...
    <div class="el-progress-circle" :style="{height:width + 'px',width:width + 'px'}" v-else>
      <svg viewBox="0 0 100 100">
        <path class="el-progress-cicrle__track" :d="trackPath" stroke="#e5e9f2" :stroke-width="relativeStrokeWidth" fill="none"></path> 
  ...
  export default {
    ...
    computed:{
      ...
      trackPath(){
        ...
        return `M 50 50 m 0 -${radius} a ${radius} ${radius} ${radius} 0 1 1 0 ${radius * 2} a ${radius} 0 1 1 0 -${radius * 2}`;
      },
      perimeter(){
