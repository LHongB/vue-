;(function(win, doc) {
	...
	CustomBar.prototype = {
		...
		init : function(options) {
			...
			console.log(this.contenSubject.scrollWidth);
			...
			if( this.scaleX>=1 ) {
			    ...
			    this.scrollBarX.style.width = this.width + 'px';
					this.eventBindX();
				console.log(this.scrollBarX.className);
				console.log(this.scrollBoxX.className);
				console.log(this.contenSubject.style);	
			}
			if( this.scaleY>=1 ) {
				this.scaleY = 1;
